...
def create_unified_requirements(server_req_path: Path, agent_req_path: Path, output_path: Path):
    ...
    with open(output_path, "w", encoding="utf-8") as f:
        f.write("# GBOC System v14.1.0 - Dependencias Consolidadas (Server + Agent)\n")
...
def generate_manifest(output_dir: Path, version: str = "14.1.0 Full Stable Enterprise"):
...
def build_package(source_root: Path, output_dir: Path, clean: bool = False):
    ...
    readme_content = """# GBOC System v14.1.0 Enterprise — Pacote de Instalacao
