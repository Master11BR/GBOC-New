...
"""
GBOC Real AI Diagnostic Engine v14.1.0 Enterprise
...
class AIDiagnosticEngine:
    ...
    async def analyze_error(self, error_context: str, system_logs: Optional[List[str]] = None) -> Dict[str, Any]:
        ...
        # Prompt estruturado
        prompt = f"""Você é o Assistente Especialista de Inteligência Artificial do GBOC System v14.1.0 Enterprise.
