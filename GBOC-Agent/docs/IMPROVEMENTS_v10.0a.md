...
# GBOC v14.6.0 - Relatório de Melhorias e Correções
...
O GBOC foi atualizado para a versão **14.6.0** com **UNIFICAÇÃO COMPLETA** entre agente e servidor, implementando recursos avançados inspirados no **Duplicati** e sistemas de diagnóstico preemptivo de última geração.
...
✅ **APIs v14.6.0**: 13 novos endpoints para funcionalidades avançadas  
...
```
✅ agent_server.py → version="14.6.0"
✅ gboc_server.py → SERVER_VERSION = "14.6.0"
...
2. **IMPROVEMENTS_v14.6.0.md** (este documento)
...
- [x] Agente inicia na v14.6.0
- [x] Servidor inicia na v14.6.0
...
A versão **14.6.0** do GBOC representa um **marco significativo** no desenvolvimento do sistema, trazendo:
