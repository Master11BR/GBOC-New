...
# TODO: Consolidação do Sistema GBOC (v14.6.0)

## Status: ✅ Concluído (Release v14.6.0)
...
- [x] Sincronização global da versão **14.6.0** via `version_unifier.py`
...
- [x] Atualização do `INSTALADORES_README.md` para v14.6.0 (Agosto/2026)
