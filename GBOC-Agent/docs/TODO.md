...
# TODO: Consolidação do Sistema GBOC (v14.1.0)

## Status: ✅ Concluído (Release v14.1.0)
...
- [x] Sincronização global da versão **14.1.0** via `version_unifier.py`
...
- [x] Atualização do `INSTALADORES_README.md` para v14.1.0 (Agosto/2026)
