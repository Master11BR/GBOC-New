...
# GBOC v14.6.0 - Sistema de Backup e Monitoramento

## 📋 Visão Geral

O GBOC (Generic Backup Operations Center) v14.6.0 é um sistema completo de gerenciamento de backups com recursos avançados de diagnóstico, monitoramento e análise estatística, inspirado no Duplicati.

### ✨ Novidades da v14.6.0

- ✅ **Versão Unificada**: Agente e Servidor sincronizados na versão 14.6.0
...
│   │   ├── diagnostics.py
│   │   ├── statistics.py
│   │   ├── advanced_stats_api.py    # ✨ Nova API v14.6.0
│   │   ├── preemptive_api.py        # ✨ Nova API v14.6.0
│   │   └── system_api.py            # ✨ Nova API v14.6.0
│   │
...
│   └── static/                 # Frontend web
│
└── GBOC-Server/               # Servidor Central (v14.6.0)
...
Unifica todas as versões para 14.6.0:
