...
# ========================================
# GBOC Agent 14.0.0 - Inicializacao
# ========================================

Write-Host "`n========================================" -ForegroundColor Cyan
Write-Host "  GBOC Agent 14.0.0 - Iniciando..." -ForegroundColor Cyan
Write-Host "========================================`n" -ForegroundColor Cyan
...
Write-Host "[OK] Iniciando GBOC Agent 14.0.0..." -ForegroundColor Green
