...
# ========================================
# GBOC Agent 14.1.0 - Inicializacao
# ========================================

Write-Host "`n========================================" -ForegroundColor Cyan
Write-Host "  GBOC Agent 14.1.0 - Iniciando..." -ForegroundColor Cyan
Write-Host "========================================`n" -ForegroundColor Cyan
...
Write-Host "[OK] Iniciando GBOC Agent 14.1.0..." -ForegroundColor Green
