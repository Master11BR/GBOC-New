#!/usr/bin/env python3
"""
GBOC 14.1.0 - Executar Diagnóstico Completo
...
def main():
    ...
    print("\n" + "=" * 80)
    print(" GBOC 14.1.0 - DIAGNÓSTICO COMPLETO DO SISTEMA")
    print("=" * 80 + "\n")
    ...
    print("\n[2/4] Unificando versões para 14.1.0...")
    try:
    ...
    print(f"\n✓ Sistema diagnosticado: GBOC 14.1.0")
